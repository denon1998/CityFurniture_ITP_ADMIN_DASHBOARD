...
class Home extends Component {
  ...
  retrievePosts() {
    axios.get("http://furniture-store-backend.herokuapp.com/api/paypalposts").then(res => {
  ...
  //delete function 
  onDelete = (id) => {
    axios.delete(`http://furniture-store-backend.herokuapp.com/api/paypalpost/delete/${id}`).then((res) => {
