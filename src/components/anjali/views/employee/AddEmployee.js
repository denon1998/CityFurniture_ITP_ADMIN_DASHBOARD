...
function AddEmployee() {
  ...
  const handleSubmit = () => {
    ...
    // axios post request
      ...
      axios.post('https://furniture-store-backend.herokuapp.com/api/employees', employee)
      .then(response =>{
    ...
    const takeANewEmpId = () => {
      ...
      axios.get('https://furniture-store-backend.herokuapp.com/api/employees/lastid')
      .then(response => {
