...
function LeavedEmp() {
    ...
    const classes = useStyles();
        ...
        const jsPdfGenerator = () => {
            ...
            doc.text(600, 20 ,'Leaved Employee Details Report', { align: 'center' });
            doc.autoTable({  html:'#LeavedEmp-table' })
            ...
            //save the pdf
            doc.save("Leaved Employee Details.pdf");
          }
          ...
          return (
            <div>
              <TextField  id="outlined-basic" label="Search by Employee ID" variant="outlined" value={search} onChange={handleChangeSearch} />
               ...
               <Table id = "LeavedEmp-table" className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
